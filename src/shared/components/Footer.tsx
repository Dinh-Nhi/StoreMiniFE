          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="d-flex flex-column text-start footer-item">
                ...
                <Link to="/login" className="btn-link">My Account</Link>
                <Link to="/products" className="btn-link">Shop details</Link>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <img src="/placeholder.png" className="img-fluid" alt="Payment methods" />
              </div>
            </div>
          </div>
        </div>
